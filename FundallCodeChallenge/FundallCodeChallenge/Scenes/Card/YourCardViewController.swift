...
class YourCardViewController: UIViewController {
...
//        stackView.addArrangedSubview(transactionView4)
    ...
    func setUpContinueButton() {
       ...
       continueButton.backgroundColor = UIColor(named: "fundallColorOne")
       ...
       continueButton.addTarget(self, action: #selector(didPressSignUpBtn), for: .touchUpInside)
